...
for bit in range(32):
    gimli.apply_and(
        "s{}".format(wordsize + bit),
        "s{}".format(2 * wordsize + bit),
        "tand0{}".format(bit),
    )

for bit in range(a, 32):
    gimli.apply_xor(
        "s{}".format(0 + bit), "tand0{}".format(bit - a), "txor{}".format(bit)
    )
...
for bit in range(32):
    gimli.apply_and(
        "s{}".format(0 + bit), "s{}".format(2 * wordsize + bit), "tor{}".format(bit)
    )  # TODO: Replace with or?

for bit in range(b, 32):
    gimli.apply_xor(
        "s{}".format(0 + bit), "tor{}".format(bit - b), "txor{}".format(bit)
    )
...
for bit in range(b, 32):
    gimli.apply_xor(
        "txor{}".format(bit), "s{}".format(wordsize + bit), "tnewy{}".format(bit)
    )
...
for bit in range(32):
    gimli.apply_and(
        "s{}".format(0 + bit), "s{}".format(wordsize + bit), "tand{}".format(bit)
    )

for bit in range(c, 32):
    gimli.apply_xor(
        "s{}".format(wordsize + bit), "tor{}".format(bit - c), "txor{}".format(bit)
    )
...
for bit in range(c, 32):
    gimli.apply_xor(
        "txor{}".format(bit), "s{}".format(2 * wordsize + bit), "tnewx{}".format(bit)
    )
...
for bit in range(wordsize):
    ...
    gimli.apply_and(
        "tnewy{}".format(bit), "tnewy{}".format(bit), "s{}".format(wordsize + bit)
    )
    gimli.apply_and(
        "tnewz{}".format(bit), "tnewz{}".format(bit), "s{}".format(2 * wordsize + bit)
    )
